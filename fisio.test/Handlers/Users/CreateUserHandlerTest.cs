...
namespace fisio.test.Handlers.Users
{
    public class CreateUserHandlerTest
    {
        ...
        {
            var command = new CreateUserCommand("Felipe Lima", "42516423845", "", "M", "18997642032", "", DateTime.UtcNow.AddYears(-20), "Fullstack", "", "", "", "Married", "", "", "Av. Paulo Marcondes", "190", "Jd. Eldorado", "President Prud.", "SP", "19025000", "felipe.test@gmail.com", "silypassword", EUserType.Patient);            var handler = new CreateUserHandler(_userRepository, _patientRepository);
